/*
 ...
 License: MIT
*/
function TastypieConfig(e){e.defaults.stripTrailingSlashes=!1}
...
return f(b)};b.prototype.next=function(){if(this.meta.next)return m(this,g.resource_domain+this.meta.next);var a="[$tastypiePaginator][next] ".concat("Not exist next pages.");return f(a)};b.prototype.previous=function(){if(this.meta.previous)return m(this,g.resource_domain+this.meta.previous);var a="[$tastypiePaginator][previous] ".concat("Not exist previous pages.");return f(a)};b.prototype.refresh=function(){return a(this,this.index,!0)};b.prototype.first=function(){return a(this,1,!1)};b.prototype.last=
function(){return a(this,this.length,!1)};return b}
...
function TastypieResourceFactory(e,g,k,b){return function(f,e){if(!f)throw"[$tastypieResource] Unknown service name.";this.endpoint=g.resource_url.concat(f,"/");this.defaults=e||{};this.page={};this.objects=new b(this)}}var ResourceTastypieModule=angular.module("ngResourceTastypie",["ngResource"]);TastypieConfig.$inject=["$resourceProvider"];ResourceTastypieModule.config(TastypieConfig);TastypieProvider.$inject=["$httpProvider"];ResourceTastypieModule.provider("$tastypie",TastypieProvider);
TastypiePaginatorFactory.$inject=["$resource","$tastypie","$q"];ResourceTastypieModule.factory("$tastypiePaginator",TastypiePaginatorFactory);TastypieObjectsFactory.$inject=["$resource","$tastypiePaginator","$q"];ResourceTastypieModule.factory("$tastypieObjects",TastypieObjectsFactory);TastypieResourceFactory.$inject=["$resource","$tastypie","$tastypiePaginator","$tastypieObjects"];ResourceTastypieModule.factory("$tastypieResource",TastypieResourceFactory);
